package ObjReaderInitial.cs.ru.vsu.objr;

import java.util.*;

import ObjReaderInitial.cs.ru.vsu.math.*;
import ObjReaderInitial.cs.ru.vsu.model.*;
...
public class NormalUtils {
    ...
    public static float[] findNormalFace(float arr[][]) {
    ...
    public static ArrayList<float[]> normal(HashMap<Integer, ArrayList<float[]>> map) {
